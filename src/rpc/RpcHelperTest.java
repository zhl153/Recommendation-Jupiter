...
public class RpcHelperTest {
	...
	public void testGetJSONArray() throws JSONException {
		...
		Item one = new ItemBuilder().setItemId("one").setAddress("33.33").setRating(5).setCategories(category).setUrl("33.33").build();
		Item two = new ItemBuilder().setItemId("two").setAddress("33.33").setRating(5).setCategories(category).setUrl("33.33").build();
...
//			testRes.put(listItem.get(i).toJSONObject());
//		}
